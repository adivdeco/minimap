        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
                <div className="text-center text-white">
                    ...
                    <p className="text-gray-400">Only Admin and Co-Admin can add libraries.</p>
                </div>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 py-8 px-4">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-white">Add New Library</h1>
                    <p className="text-gray-400 mt-2">Fill in the details to register a new library</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    {/* Owner Details */}
                    <div className="backdrop-blur-xl bg-white/10 rounded-2xl border border-white/20 p-6">
                        <h2 className="text-xl font-semibold text-white mb-4">Library Owner Details</h2>
                        <p className="text-gray-400 text-sm mb-4">If owner doesn't exist, a new account will be created</p>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-200 mb-2">Owner Email</label>
                                <input
                                    type="email"
                                    name="ownerEmail"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-200 mb-2">Owner Phone</label>
                                <input
                                    type="tel"
                                    name="ownerPhone"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-200 mb-2">Owner Password (for new accounts)</label>
                                <input
                                    type="password"
                                    name="ownerPassword"
                        ...
                        <div className="space-y-4">
                            {formData.plans.map((plan, index) => (
                                <div key={index} className="grid grid-cols-1 md:grid-cols-4 gap-4 p-4 bg-white/5 rounded-lg">
                                    <div>
                                        <label className="block text-sm font-medium text-gray-200 mb-2">Plan Title</label>
                                        <input
                                            type="text"
                                            value={plan.title}
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-gray-200 mb-2">Duration (days)</label>
                                        <input
                                            type="number"
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full py-4 px-6 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-bold text-lg rounded-xl hover:from-purple-700 hover:to-pink-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-slate-900 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        {loading ? (
